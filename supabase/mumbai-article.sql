-- ============================================================================
-- Mumbai blog article, full text
-- ============================================================================
-- Run this whole file in: Supabase Dashboard -> SQL Editor -> New Query -> Run
--
-- It deletes any existing Mumbai article and inserts the full article twice:
--   1. page_type = 'city'      -> shows on the Mumbai city page
--   2. page_type = 'coworking' -> shows on every Mumbai coworking page
--
...
BEGIN
  ...
  ELSE
    ...
    INSERT INTO blog_articles
      (page_type, city_slug, title, eyebrow, subtitle, content, content_format)
    VALUES
      ('city',      'mumbai', article_title, 'Guide', article_subtitle, md, 'markdown'),
      ('coworking', 'mumbai', article_title, 'Guide', article_subtitle, md, 'markdown');
  END IF;

  RAISE NOTICE 'Mumbai article inserted. content column type: %', col_type;
END
$do$;
