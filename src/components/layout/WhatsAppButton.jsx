...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-20 right-6 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-card-hover transition-transform hover:scale-110"
    >
