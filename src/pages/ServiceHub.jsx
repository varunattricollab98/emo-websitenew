...
// City images: use the actual featured_image from each city's Supabase space
// listing. This is the simplest, most reliable approach — no external URLs that
// may break, and the photos are already uploaded and verified by the team.
// The liveCities aggregation below pulls the image from the first space row.
