      ...
      <div className="mx-auto max-w-7xl px-4 py-8">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">Manage career listings and vacancies.</p>
          </div>
        ...
        {!loading && jobs.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="mt-1 text-sm text-slate-500">Create your first job opening to get started.</p>
            <Link
              to="/admin/jobs/new"
                  ...
                  {filtered.map((job) => {
                    ...
                    return (
                      <tr key={job.id} className="transition hover:bg-slate-50/80">
                        ...
                        <td className="px-5 py-3.5">
                          <span className={`inline-flex rounded-full px-2.5 py-1 text-xs font-medium ${typeBadge}`}>
                            {job.employment_type || '-'}
                          </span>
                        </td>
                        <td className="px-5 py-3.5">
                        ...
                        <td className="px-5 py-3.5 text-slate-600">{job.sort_order ?? '-'}</td>
                        <td className="px-5 py-3.5">
        ...
        {!loading && jobs.length > 0 && filtered.length === 0 && (
          <div className="py-12 text-center text-slate-500">No jobs match your search.</div>
        )}
      </div>
    </div>
  )
